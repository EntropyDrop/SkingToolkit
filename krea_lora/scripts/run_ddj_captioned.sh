...
# Re-render the target sheet after captioning so the two fixed views use the
# latest equal-half layout and safety margins before any target latent cache is
