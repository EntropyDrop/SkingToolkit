...
PARSER_SEMANTIC_GATE_RADIUS="${PARSER_SEMANTIC_GATE_RADIUS:-1}"
PARSER_SPLAT_COLOR_AGGREGATION="${PARSER_SPLAT_COLOR_AGGREGATION:-quantized_mode}"
PARSER_SPLAT_COLOR_MODE_BITS="${PARSER_SPLAT_COLOR_MODE_BITS:-5}"
PARSER_SPLAT_COLOR_MODE_CONFIDENCE_RATIO="${PARSER_SPLAT_COLOR_MODE_CONFIDENCE_RATIO:-0.85}"
