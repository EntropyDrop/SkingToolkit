...
PARSER_AFFINE_REFINE_TRANSLATION_PX="${PARSER_AFFINE_REFINE_TRANSLATION_PX:-8.0}"
...
PARSER_OUTER_ROUTE_CONFIDENCE_THRESHOLD="${PARSER_OUTER_ROUTE_CONFIDENCE_THRESHOLD:-0.10}"
PARSER_OUTER_ROUTE_MARGIN_THRESHOLD="${PARSER_OUTER_ROUTE_MARGIN_THRESHOLD:-0.20}"
PARSER_OUTER_UV_MIN_COVERAGE="${PARSER_OUTER_UV_MIN_COVERAGE:-0.5}"
