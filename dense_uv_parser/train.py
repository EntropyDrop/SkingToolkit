...
def build_arg_parser():
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Recursively load paired *_edited renders and versioned 64x64 UVs "
    ...
    parser.add_argument(
        "--real_semantic_result_suffix",
        default="_v94_result",
        help=(
            "Strict result suffix paired with *_edited inputs. The default "
            "uses UVs regenerated by the v94 baseline."
        ),
    )
...
def main():
    ...
    if args.real_semantic_data_dir:
        ...
        if (
            not args.real_semantic_result_suffix.startswith("_")
            or "/" in args.real_semantic_result_suffix
            or "\\" in args.real_semantic_result_suffix
        ):
            raise ValueError(
                "--real_semantic_result_suffix must start with '_' and "
    ...
    if args.real_semantic_data_dir:
        dataset = PairedRenderSkinDataset(
            ...
            result_suffix=args.real_semantic_result_suffix,
        )
        print(
    ...
    metadata = {
        ...
        "real_semantic_result_suffix": (
            args.real_semantic_result_suffix
            if args.real_semantic_data_dir
            else None
        ),
