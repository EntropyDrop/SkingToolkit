...
HEAD_OUTER_TOPOLOGY_RELAXED_ROUTE_THRESHOLD="${HEAD_OUTER_TOPOLOGY_RELAXED_ROUTE_THRESHOLD:-0.25}"
HEAD_OUTER_TOPOLOGY_RELAXED_SEMANTIC_THRESHOLD="${HEAD_OUTER_TOPOLOGY_RELAXED_SEMANTIC_THRESHOLD:-0.65}"
HEAD_OUTER_TOPOLOGY_SEMANTIC_ONLY_THRESHOLD="${HEAD_OUTER_TOPOLOGY_SEMANTIC_ONLY_THRESHOLD:-0.85}"
HEAD_OUTER_TOPOLOGY_MIN_SEED_NODES="${HEAD_OUTER_TOPOLOGY_MIN_SEED_NODES:-2}"
HEAD_OUTER_TOPOLOGY_COLOR_TOLERANCE="${HEAD_OUTER_TOPOLOGY_COLOR_TOLERANCE:-0.30}"
