...
case "$ROUTING_PROFILE" in
  ...
  conservative)
    ...
    DEFAULT_ROUTE_CONFIDENCE_THRESHOLD="0.50"
    DEFAULT_ROUTE_MARGIN_THRESHOLD="0.15"
    DEFAULT_OUTER_ROUTE_CONFIDENCE_THRESHOLD="0.65"
    DEFAULT_OUTER_ROUTE_MARGIN_THRESHOLD="0.40"
    DEFAULT_OUTER_UV_MIN_COVERAGE="0.15"
