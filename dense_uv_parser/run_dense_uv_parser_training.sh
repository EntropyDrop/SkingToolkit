...
# The front/back overlap covers only a small fraction of visible outer texels.
# Keep the legacy cross-view veto opt-in until all single-view candidates are
# supervised directly.
