...
if [[ "$PREDICT_HEAD_OUTER_STRUCTURE" == "true" ]]; then
  ...
  DEFAULT_HEAD_OUTER_SPARSE_RECALL_WEIGHT=0.25
  DEFAULT_HEAD_OUTER_SYMMETRY_SCORE_WEIGHT=0.15
  DEFAULT_HEAD_OUTER_RING_WORST_FACE_RECALL_WEIGHT=0.40
  DEFAULT_HEAD_OUTER_OPEN_TOP_SHAPE_WEIGHT=0.60
  DEFAULT_HEAD_OUTER_ACCESSORY_CLASSIFICATION_WEIGHT=0.30
  DEFAULT_HEAD_OUTER_ROUTE_CONNECTIVITY_WEIGHT=0.40
else
