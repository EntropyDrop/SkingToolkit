...
if [[ "$PREDICT_HEAD_OUTER_STRUCTURE" == "true" ]]; then
  ...
  DEFAULT_HEAD_OUTER_OCCUPANCY_WEIGHT=0.45
  DEFAULT_HEAD_OUTER_TOPOLOGY_WEIGHT=0.15
  DEFAULT_HEAD_OUTER_SYMMETRY_WEIGHT=0.05
  DEFAULT_HEAD_OUTER_COMPONENT_HARD_RECALL_WEIGHT=0.20
  DEFAULT_HEAD_OUTER_SPARSE_RECALL_WEIGHT=0.15
  DEFAULT_HEAD_OUTER_SYMMETRY_SCORE_WEIGHT=0.10
  DEFAULT_HEAD_OUTER_RING_WORST_FACE_RECALL_WEIGHT=0.25
  DEFAULT_HEAD_OUTER_OPEN_TOP_SHAPE_WEIGHT=0.30
  DEFAULT_HEAD_OUTER_ACCESSORY_CLASSIFICATION_WEIGHT=0.10
  DEFAULT_HEAD_OUTER_ROUTE_CONNECTIVITY_WEIGHT=0.25
else
