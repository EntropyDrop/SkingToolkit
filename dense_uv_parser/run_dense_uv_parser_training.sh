...
if [[ "$HEAD_OUTER_PROJECTED_INPUT_VERSION" -ge 5 ]]; then
  DEFAULT_HEAD_EYE_OCCUPANCY_WEIGHT=0.55
  DEFAULT_HEAD_EYE_PRESENCE_WEIGHT=0.15
  DEFAULT_HEAD_EYE_SYMMETRY_WEIGHT=0.20
  DEFAULT_HEAD_EYE_ROUTE_CONNECTIVITY_WEIGHT=0.40
  DEFAULT_HEAD_EYE_ROUTE_SYMMETRY_WEIGHT=0.30
else
...
HEAD_EYE_OCCUPANCY_POSITIVE_BALANCE="${HEAD_EYE_OCCUPANCY_POSITIVE_BALANCE:-0.60}"
HEAD_EYE_HARD_FRACTION="${HEAD_EYE_HARD_FRACTION:-0.25}"
HEAD_EYE_HARD_POSITIVE_WEIGHT="${HEAD_EYE_HARD_POSITIVE_WEIGHT:-0.75}"
HEAD_EYE_HARD_NEGATIVE_WEIGHT="${HEAD_EYE_HARD_NEGATIVE_WEIGHT:-0.50}"
