...
HEAD_OUTER_PROJECTED_INPUT_VERSION="${HEAD_OUTER_PROJECTED_INPUT_VERSION:-2}"
...
if [[ "$PREDICT_HEAD_OUTER_STRUCTURE" == "true" ]]; then
  ...
  DEFAULT_HEAD_OUTER_OCCUPANCY_WEIGHT=0.35
  DEFAULT_HEAD_OUTER_TOPOLOGY_WEIGHT=0.10
