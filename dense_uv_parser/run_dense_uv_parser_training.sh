...
OUTER_UV_ROUTE_EVIDENCE_DROPOUT="${OUTER_UV_ROUTE_EVIDENCE_DROPOUT:-0.15}"
...
OUTER_UV_OCCUPANCY_GATE_THRESHOLD="${OUTER_UV_OCCUPANCY_GATE_THRESHOLD:-0.0}"
...
LAMBDA_OUTER_FALSE_NEGATIVE="${LAMBDA_OUTER_FALSE_NEGATIVE:-1.0}"
...
LAMBDA_OUTER_COMPONENT_FALSE_POSITIVE="${LAMBDA_OUTER_COMPONENT_FALSE_POSITIVE:-0.05}"
LAMBDA_OUTER_TOPOLOGY="${LAMBDA_OUTER_TOPOLOGY:-0.10}"
LAMBDA_OUTER_NEGATIVE_TOPOLOGY="${LAMBDA_OUTER_NEGATIVE_TOPOLOGY:-0.03}"
...
LAMBDA_OUTER_PROJECTION_FALSE_POSITIVE="${LAMBDA_OUTER_PROJECTION_FALSE_POSITIVE:-0.25}"
LAMBDA_OUTER_PROJECTION_FALSE_NEGATIVE="${LAMBDA_OUTER_PROJECTION_FALSE_NEGATIVE:-1.0}"
LAMBDA_OUTER_PROJECTION_DICE="${LAMBDA_OUTER_PROJECTION_DICE:-0.50}"
LAMBDA_OUTER_PROJECTED_AREA="${LAMBDA_OUTER_PROJECTED_AREA:-0.10}"
OUTER_SELECTION_PRECISION_WEIGHT="${OUTER_SELECTION_PRECISION_WEIGHT:-1.0}"
OUTER_SELECTION_RECALL_WEIGHT="${OUTER_SELECTION_RECALL_WEIGHT:-1.0}"
...
OUTER_PROJECTION_FP_SELECTION_WEIGHT="${OUTER_PROJECTION_FP_SELECTION_WEIGHT:-0.25}"
OUTER_PROJECTION_AREA_SELECTION_WEIGHT="${OUTER_PROJECTION_AREA_SELECTION_WEIGHT:-0.10}"
