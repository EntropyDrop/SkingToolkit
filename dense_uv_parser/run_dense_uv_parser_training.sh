...
MAX_SAMPLES="${MAX_SAMPLES:-490000}"
...
LAMBDA_OUTER_FALSE_POSITIVE="${LAMBDA_OUTER_FALSE_POSITIVE:-1.25}"
...
SOFT_UV_ALPHA_HARD_FRACTION="${SOFT_UV_ALPHA_HARD_FRACTION:-0.10}"
SOFT_UV_ALPHA_HARD_WEIGHT="${SOFT_UV_ALPHA_HARD_WEIGHT:-0.75}"
LAMBDA_RENDER_RGB="${LAMBDA_RENDER_RGB:-0.40}"
LAMBDA_RENDER_ALPHA="${LAMBDA_RENDER_ALPHA:-0.50}"
RENDER_HARD_FRACTION="${RENDER_HARD_FRACTION:-0.02}"
RENDER_HARD_WEIGHT="${RENDER_HARD_WEIGHT:-0.50}"
OUTER_SELECTION_PRECISION_WEIGHT="${OUTER_SELECTION_PRECISION_WEIGHT:-2.00}"
...
RENDER_SOFTMAX_TEMPERATURE="${RENDER_SOFTMAX_TEMPERATURE:-0.5}"
...
python train.py \
  ...
  --soft_uv_alpha_hard_fraction "$SOFT_UV_ALPHA_HARD_FRACTION" \
  --soft_uv_alpha_hard_weight "$SOFT_UV_ALPHA_HARD_WEIGHT" \
  --lambda_render_rgb "$LAMBDA_RENDER_RGB" \
  --lambda_render_alpha "$LAMBDA_RENDER_ALPHA" \
  --render_hard_fraction "$RENDER_HARD_FRACTION" \
  --render_hard_weight "$RENDER_HARD_WEIGHT" \
