...
OUTER_UV_ROUTE_EVIDENCE_DROPOUT="${OUTER_UV_ROUTE_EVIDENCE_DROPOUT:-0.50}"
...
OUTER_UV_MIN_SOURCE_PIXELS="${OUTER_UV_MIN_SOURCE_PIXELS:-30}"
...
GEOMETRY_ROUTE_CONSENSUS_OUTER_CONFIDENCE="${GEOMETRY_ROUTE_CONSENSUS_OUTER_CONFIDENCE:-0.80}"
GEOMETRY_ROUTE_CONSENSUS_OUTER_MARGIN="${GEOMETRY_ROUTE_CONSENSUS_OUTER_MARGIN:-0.35}"
...
LAMBDA_CROSS_VIEW_OUTER_VISIBILITY="${LAMBDA_CROSS_VIEW_OUTER_VISIBILITY:-0.50}"
...
OUTER_HARD_POSITIVE_WEIGHT="${OUTER_HARD_POSITIVE_WEIGHT:-0.25}"
OUTER_HARD_NEGATIVE_FRACTION="${OUTER_HARD_NEGATIVE_FRACTION:-0.10}"
OUTER_HARD_NEGATIVE_WEIGHT="${OUTER_HARD_NEGATIVE_WEIGHT:-1.0}"
LAMBDA_OUTER_COMPONENT_RECALL="${LAMBDA_OUTER_COMPONENT_RECALL:-0.10}"
LAMBDA_OUTER_COMPONENT_FALSE_POSITIVE="${LAMBDA_OUTER_COMPONENT_FALSE_POSITIVE:-0.25}"
...
OUTER_OCCUPANCY_AGREEMENT_WARMUP_FRACTION="${OUTER_OCCUPANCY_AGREEMENT_WARMUP_FRACTION:-0.50}"
...
LAMBDA_OUTER_PROJECTION_FALSE_POSITIVE="${LAMBDA_OUTER_PROJECTION_FALSE_POSITIVE:-1.0}"
LAMBDA_OUTER_PROJECTION_FALSE_NEGATIVE="${LAMBDA_OUTER_PROJECTION_FALSE_NEGATIVE:-0.50}"
LAMBDA_OUTER_PROJECTION_DICE="${LAMBDA_OUTER_PROJECTION_DICE:-0.25}"
LAMBDA_OUTER_PROJECTED_AREA="${LAMBDA_OUTER_PROJECTED_AREA:-0.25}"
...
OUTER_PROJECTION_FP_SELECTION_WEIGHT="${OUTER_PROJECTION_FP_SELECTION_WEIGHT:-1.0}"
OUTER_PROJECTION_AREA_SELECTION_WEIGHT="${OUTER_PROJECTION_AREA_SELECTION_WEIGHT:-0.50}"
