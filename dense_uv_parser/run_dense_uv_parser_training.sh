...
MAX_SAMPLES="${MAX_SAMPLES:-360000}"
...
OUTER_VISIBILITY_HARD_NEGATIVE_FRACTION="${OUTER_VISIBILITY_HARD_NEGATIVE_FRACTION:-0.10}"
OUTER_VISIBILITY_HARD_NEGATIVE_WEIGHT="${OUTER_VISIBILITY_HARD_NEGATIVE_WEIGHT:-0.50}"
